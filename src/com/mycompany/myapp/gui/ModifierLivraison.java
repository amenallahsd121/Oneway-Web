 ...
 * @author amens
 */
public class ModifierLivraison extends BaseFormBack {

    public ModifierLivraison(Resources res, int id) {
        ...
        ajouterButton.addActionListener(e -> {
            ...
            Livraison L = new Livraison(Etat.getSelectedItem(), id, idliv);
            // Add the Livreur using the LivreurService
            ServiceLivraison.getInstance().modifierLivraison(L);
            // Show a confirmation dialog
            Dialog.show("Succès", "La Livraison a été modifié avec succès", "OK", null);

            // Go back to the LivreurList form
            new ListerLivraison(res).showBack();
        });
